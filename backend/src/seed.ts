...
async function main() {
  ...
  const wines = await Promise.all([
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/5C1A1A/FFFFFF?text=Chateau+Margaux',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/6B2020/FFFFFF?text=Tignanello',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/3D0C02/FFFFFF?text=Opus+One',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/8B0000/FFFFFF?text=Romanee-Conti',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/4A0404/FFFFFF?text=Vega+Sicilia',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/2D0A0A/FFFFFF?text=L\'Ermita',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/7B1818/FFFFFF?text=Chateau+Rayas',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/601010/FFFFFF?text=Gaja+Barbaresco',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/330000/FFFFFF?text=Penfolds+Grange',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/500A14/FFFFFF?text=Catena+Adrianna',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/D4E8C2/333333?text=Cloudy+Bay',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/F0EAD6/333333?text=Egon+Muller',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/E8E0C8/333333?text=Trimbach+Riesling',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/F5ECD7/333333?text=Puligny-Montrachet',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FFB6C1/333333?text=Whispering+Angel',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FFC0CB/333333?text=Ott+Rose',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FFFFF0/333333?text=Krug+Grande+Cuvee',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FAFAD2/333333?text=Ferrari+Giulio',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FFD700/333333?text=Chateau+d\'Yquem',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/FFA500/333333?text=TBA+Riesling',
      wineryId: wEgon.id, regionId: mosel.id,
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/3B0A0A/FFFFFF?text=Taylor+Fladgate',
    ...
    prisma.wine.create({ data: {
      ...
      imageUrl: 'https://via.placeholder.com/300x400/8B4513/FFFFFF?text=Palo+Cortado',
