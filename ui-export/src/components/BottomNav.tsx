import { Home, Search, Wine, MoreHorizontal, Camera } from 'lucide-react';
...
// Defined at module level to avoid Rules of Hooks violations
...
export function BottomNav() {
  ...
  return (
    /* Outer wrapper — centres the pill on screen */
    <div
    ...
    >
      {/* Camera FAB — floats above the pill */}
      <div className="absolute left-1/2 -translate-x-1/2" style={{ top: -26 }}>
        <button
          ...
          style={{
            ...
            height: 52,
            background: '#fff',
            border: '3.5px solid #722F37',
            boxShadow: '0 4px 20px rgba(114,47,55,0.35)',
          }}
          onClick={() => {}}
        >
          <Camera size={22} color="#722F37" />
        </button>
      </div>
