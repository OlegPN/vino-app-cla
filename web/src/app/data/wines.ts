...
export const wines: Wine[] = [
  ...
  },
  {
    ...
    region: 'Тамань',
    country: 'Россия',
    grapes: ['Каберне Совиньон', 'Сира'],
    description: 'Свежее розовое вино нежного лососёвого оттенка с ароматами клубники, малины и цветов. Приятная кислотность и лёгкое минеральное послевкусие.',
    image: '/images/wine-rose.svg',
    flavors: ['Клубника', 'Малина', 'Цитрус', 'Цветы'],
    alcohol: 12.5,
    inCollection: false,
    wishlist: false,
  },
  {
    ...
    image: '/images/wine-sparkling.svg',
